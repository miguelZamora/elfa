...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [    
                    'nombre'        => 'required|string|max:150|unique:proveedores'. $this->route('proveedores')->id.'max:150' ,  

                    'email'         => 'required|string|max:250|unique:proveedores'. $this->route('proveedores')->id.'max:250' ,  
